...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validation
    if (!formData.email.endsWith('@ucp.edu.pk')) {
      setError('Only UCP email addresses allowed (@ucp.edu.pk)');
      return;
    }
  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        ...
        <p className="auth-subtitle">Join SkillBridge - UCP Student Marketplace</p>
